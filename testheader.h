...
#ifndef _FL_TABLE_COPY_H
#define _FL_TABLE_COPY_H
 ...
 */
class Fl_Table_Copy : public Fl_Group {
public:
  /**
...
public:
   ...
   */
  Fl_Table_Copy(int X, int Y, int W, int H, const char *l=0);
